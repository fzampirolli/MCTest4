...
#arqprova.write("\\tikz \\draw[red,fill=black] (0,200) circle (2ex);\n")
    ...
    arqprova.write("\\leavevmode\\put(-14,0){\\color{black}\\circle*{15}}\\hspace{-0mm}  ")
    arqprova.write("\\leavevmode\\put(506,0){\\color{black}\\circle*{15}}")
            ...
            for t in provas:
                if fff is t[0]: # se prova é da mesma turma, acrescente
                    ...
                    if int(MCTest_sheets)!=1: # foi escolhido a opção de gerar somente o quadro de respostas
                        ...
                        arqprova.write("\n\n\\vspace{-3mm}\n")
                        arqprova.write("\\leavevmode\\put(-14,0){\\color{black}\\circle*{15}}\\hspace{-3mm}\\hrulefill  ")
                        arqprova.write("\\leavevmode\\put(-5,0){\\color{black}\\circle*{15}}")
